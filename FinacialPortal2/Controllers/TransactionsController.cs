...
namespace FinacialPortal2.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,BankAccountId,BudgetItemId,OwnerId,TransactioTypeId,Created,Account,Memo,TransactionType")] Transaction transaction)
        {
            if (ModelState.IsValid)
            {
