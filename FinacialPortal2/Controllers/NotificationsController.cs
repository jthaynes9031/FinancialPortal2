...
namespace FinacialPortal2.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,HouseholdId,Subject,Body,Created,IsRead,RecipientId")] Notification notification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,HouseholdId,Subject,Body,Created,IsRead,RecipientId")] Notification notification)
        {
            if (ModelState.IsValid)
            {
